...
void Library::addBook() {// Функция для добавления книги в библиотеку
    ...
    getline(std::cin >> std::ws, newBook.author);// Вводим фамилию и инициалы автора. ws используется для удаления лишних пробелов
    cout << "Введите название книги: ";
    getline(std::cin >> std::ws, newBook.title);// Вводим название книги
    while (true) {
